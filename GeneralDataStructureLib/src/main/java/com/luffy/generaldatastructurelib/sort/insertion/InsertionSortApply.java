package com.luffy.generaldatastructurelib.sort.insertion;
 ...
 * @desc --
 * <p>
 * 特点：在冒泡排序中，经过每一轮的排序处理后，数组后端的数是排好的；而对于插入排序来说，经过每一轮的排序处理后，数组前段的数是排好序的。
 * <p>
 * 基本思想：
 * 不断地将尚未排好序的数插入到已经排好序的部分。
 * <p>
 * 过程：
 * 插入排序从小到大排序：首先位置1上的数和位置0上的数进行比较，如果位置1上的数大于位置0上的数，将位置0上的数向后移一位，将1插入到0位置，
 ...
 * <p>
 * 题目：
 * 给定一个数组[2,1,7,9,5,8]，要求按照从左到右、从小到大的顺序进行排序。
 */
